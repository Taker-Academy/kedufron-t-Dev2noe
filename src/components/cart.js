document.addEventListener("DOMContentLoaded", function()
{
    ...
    function loadCartItems() {
        ...
        basket.forEach(product => {
            ...
            cartItem.querySelector('.cart-item-total').textContent = `${(product.price * product.quantity).toFixed(2)}`;

            // gestionnaires d'événements pour les boutons plus, moins, remove
